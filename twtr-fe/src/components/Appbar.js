...
import MyTweets from "../pages/AddTweet/MyTweets";
import MyTweetsContainer from "../pages/AddTweet/MyTweetsContainer";
...
export default function Dashboard() {
  ...
  return (
    <div className={classes.root}>
      ...
      <BrowserRouter history={history} title={title} >
        ...
        >
          ...
          <List>
            ...
            <Divider/>
             {/*SignUp menu item */}
            <ListItem button component={Link} to="/mytweets" onClick={onItemClick('Add Tweet')}>
              <ListItemIcon>
                <LayersIcon />
              </ListItemIcon>
              <ListItemText primary="Add Tweet" />
              { title === 'Add Tweet' &&
              <ListItemIcon>
                <IconButton onClick={handleDrawerCollapsed}>
                  <ChevronLeftIcon />
